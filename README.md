...
Or open it directly: [`notebooks/demo.ipynb`](notebooks/demo.ipynb)
...
| Figure | File |
|--------|------|
| Example prediction | [`results/figures/Task1/task1_example_pred.png`](results/figures/Task1/task1_example_pred.png) |
| F1 score | [`results/figures/Task1/task1_f1_score.png`](results/figures/Task1/task1_f1_score.png) |
| Per-tag confusion matrix | [`results/figures/Task1/task1_per_tag_conf_mat.png`](results/figures/Task1/task1_per_tag_conf_mat.png) |
| Top & bottom tags | [`results/figures/Task1/task1_top_bottom_tags.png`](results/figures/Task1/task1_top_bottom_tags.png) |
| Train/val curve | [`results/figures/Task1/task1_train_val.png`](results/figures/Task1/task1_train_val.png) |

### Task 2 — Graph construction + CNN/GNN
| Figure | File |
|--------|------|
| CNN model | [`results/figures/Task2/task2_cnn.png`](results/figures/Task2/task2_cnn.png) |
| Data distribution | [`results/figures/Task2/task2_data_dist.png`](results/figures/Task2/task2_data_dist.png) |
| GNN model | [`results/figures/Task2/task2_gnn.png`](results/figures/Task2/task2_gnn.png) |
| Model evaluation | [`results/figures/Task2/task2_model_eval.png`](results/figures/Task2/task2_model_eval.png) |

### Task 3 — Fusion model + ablation
| Figure | File |
|--------|------|
| Ablation study | [`results/figures/Task3/task3_ablation.png`](results/figures/Task3/task3_ablation.png) |
| LR vs epoch | [`results/figures/Task3/task3_lr_epoch.png`](results/figures/Task3/task3_lr_epoch.png) |
| Train/val curve | [`results/figures/Task3/task3_train-val.png`](results/figures/Task3/task3_train-val.png) |
